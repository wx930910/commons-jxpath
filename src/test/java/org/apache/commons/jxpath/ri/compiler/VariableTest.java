...
public class VariableTest extends JXPathTestCase {
	...
	public void setUp() {
		if (context == null) {
			...
			context.setFactory(VariableFactory.mockAbstractFactory1());
	...
	public void testUnionOfVariableAndNode() throws Exception {
		...
		assertXPathValue(context, "count($a | /list)", new Double(7)); // $o + list which contains six discrete values
																		// (one is duped, wrapped in a Container)
	}
