...
public class ExtensionFunctionTest extends JXPathTestCase {
	...
	public void testConstructorLookup() {
		...
		assertEquals("test:new(1, x)", func.invoke(ExtensionFunctionTest.mockExpressionContext1(null), args).toString(),
				"foo=1; bar=x");
	}
	...
	public void testStaticMethodLookup() {
		...
		assertEquals("test:build(1, x)",
				func.invoke(ExtensionFunctionTest.mockExpressionContext1(null), args).toString(), "foo=1; bar=x");
	}
	...
	public void testStaticMethodLookupWithConversion() {
		...
		assertEquals("test:build('7', 1)",
				func.invoke(ExtensionFunctionTest.mockExpressionContext1(null), args).toString(), "foo=7; bar=1");
	}
	...
	public void testMethodLookup() {
		...
		assertEquals("test:getFoo($test, 1, x)",
				func.invoke(ExtensionFunctionTest.mockExpressionContext1(null), args).toString(), "0");
	}

	public void testStaticMethodLookupWithExpressionContext() {
		Object[] args = new Object[0];
		Function func = functions.getFunction("test", "path", args);
		assertEquals("test:path()", func.invoke(ExtensionFunctionTest.mockExpressionContext1(new Integer(1)), args),
				"1");
	}
	...
	public void testMethodLookupWithExpressionContext() {
		...
		assertEquals("test:instancePath()",
				func.invoke(ExtensionFunctionTest.mockExpressionContext1(new Integer(1)), args), "1");
	}
	...
	public void testStaticMethodCall() {
		...
		assertXPathValue(context, "string(" + TestFunctions.class.getName() + ".build(8, 'goober'))",
				"foo=8; bar=goober");
